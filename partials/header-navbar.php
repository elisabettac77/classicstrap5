...
<div id="wrapper-navbar" itemscope itemtype="http://schema.org/WebSite">
    ...
    <a class="skip-link visually-hidden-focusable" href="#theme-main">
        <?php esc_html_e('Skip to content', 'classicstrap5'); ?>
    </a>


    <nav data-bs-theme="<?php echo get_theme_mod('classicstrap_header_navbar_color_scheme_attr', 'dark') ?>"
        class="navbar <?php echo get_theme_mod('classicstrap_header_navbar_expand', 'navbar-expand-lg'); ?> <?php echo get_theme_mod('classicstrap_header_navbar_position') . " " . get_theme_mod('classicstrap_header_navbar_color_choice', 'bg-dark'); ?>"
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <?php if (get_theme_mod('enable_search_form')): ?>
                    <form action="<?php echo bloginfo('url') ?>" method="get" id="header-search-form" class="me-4">
                        <input class="form-control" type="text" placeholder="<?php _e("Search", 'classicstrap5') ?>" aria-label="<?php _e("Search", 'classicstrap5') ?>" name="s"
                ...
                <?php if (get_theme_mod('enable_dark_mode_switch')): ?>
                    <div class="d-flex align-items-center gap-1 mt-4 mt-md-0 navbar-text">
                        ...
                        <div class="form-check form-switch">
                            ...
                            <label class="form-check-label visually-hidden" for="theme-toggle"> <?php _e("Toggle Dark / Light mode", 'classicstrap5') ?>
                            </label>
                        </div>
