...
//ADD THEME OPTIONS PAGE
function add_classicstrap_theme_page() {
    add_theme_page( 'classicstrap Theme Options Page', 'classicstrap Options', 'edit_theme_options', 'classicstrap-theme-options', 'theme_option_page' );
}
add_action( 'admin_menu', 'add_classicstrap_theme_page' );
	...
	<div class="pico-wrap">
        ...
        <div class="pico-welcome-panel">
            ...
            <div class="pico-welcome-panel-content">
                ...
                <h2>Welcome to classicstrap5 v<?php echo pico_get_parent_theme_version() ?></h2>
                ...
                Hit "<b>Publish</b>" and classicstrap will recompile the Bootstrap SCSS code "on the fly" (and optionally include YOUR additional CSS / SCSS files). </p>
                <p>A <b>single, minified <a href="<?php echo classicstrap_get_css_url() ?>" target="_blank">CSS file</a></b> is generated and served. </p>
                ...
                <div class="pico-container">
					...
					<div class="pico-column" style="width:55%;">
                            ...
                            <h3>Get Started</h3>
                            <a class="button button-hero" target="_blank" href="https://classicstrap.com/docs/">Theme Documentation</a>
							<br><br>
                    ...
                    <div class="pico-column"  hidden>
                        ...
                        <ul id="pico-utils">
									...
									<li>
										<a target="_blank" href="https://classicstrap.com/" class="">
											<svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" viewBox="0 0 16 16" style="" lc-helper="svg-icon">
												<path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-4h2v4a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146zM2.5 14V7.707l5.5-5.5 5.5 5.5V14H10v-4a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v4H2.5z"></path>
											</svg>
											<span>Learn more at classicstrap.com</span>
										</a>
		...
		<div class="metabox-holder">
			<div class="postbox" style="padding: 0 10px;"> 
				...
				if (  get_template_directory() === get_stylesheet_directory()) {
					echo '
					<h2>Please do not edit directly the classicstrap theme folder. </h2>
					
					<p>To add your own [SASSy] CSS code, you need to enable a child theme. Download our child theme starter for free at <a target="_new" href="https://classicstrap.com/#downloads">classicstrap.com</a>. </p>
