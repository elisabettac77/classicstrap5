...
if ( ! function_exists( 'classicstrap_pagination' ) ) {
	/**
	 ...
	 */
	function classicstrap_pagination( $args = array(), $class = 'pagination pagination-lg' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'classicstrap5' ),
				'next_text'          => __( '&raquo;', 'classicstrap5' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'classicstrap5' ),
			)
		);
