...
<body <?php body_class(); ?>>
	...
	<?php 
    // Custom filter to check if header elements should be displayed. To disable, use: add_filter('classicstrap_enable_header_elements', '__return_false');
    if (apply_filters('classicstrap_enable_header_elements', true)):
